...
//Reducer
import { authReducer, cartReducer, favoriteReducer, orderReducer, productReducer } from "./src/reducers";
//Navigator
...
export default function App() {
  ...
  if (!assetLoaded) {
    return <AppLoading startAsync={LoadAssets} onFinish={() => setAssetLoaded(true)} onError={console.warn} />;
  }
  return (
