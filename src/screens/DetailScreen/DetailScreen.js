...
export const DetailScreen = (props) => {
  ...
  //Favorite
  const FavoriteProducts = useSelector((state) => state.fav.favoriteList.some((product) => product._id === item._id));
  useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      {showSnackbar ? <Snackbar checkVisible={showSnackbar} message={message} /> : <View />}
